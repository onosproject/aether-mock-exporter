...
import (
	"github.com/onosproject/aether-mock-exporter/pkg/collector"
...
func main() {
	collector.RecordSiteMetrics(3*time.Minute, "acme-chicago-monitoring-pi-1")
	collector.RecordSiteMetrics(3*time.Minute, "acme-chicago-monitoring-pi-2")
